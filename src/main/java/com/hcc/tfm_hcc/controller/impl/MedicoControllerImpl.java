...
public class MedicoControllerImpl implements MedicoController {
    ...
    public ResponseEntity<java.util.List<SolicitudAsignacion>> listarSolicitudesPendientes() {
        java.util.List<SolicitudAsignacion> lista = medicoFacade.listarSolicitudesPendientes();
