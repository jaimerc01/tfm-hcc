 ...
 * Proporciona operaciones de persistencia y consulta en MongoDB para
 * archivos médicos asociados a usuarios específicos.
 *
 ...
 * @since 1.0
 */
public interface ArchivoClinicoRepository extends MongoRepository<ArchivoClinico, UUID> {
